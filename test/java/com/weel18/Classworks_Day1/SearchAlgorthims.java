...
public class SearchAlgorthims {
	 ...
	 * 
	 * Pseudo code : 
	 Initialize the two integer variables left to zero and right to length minus one
	 while loop iterate till the left< right
	 if the left+right/2 value is less than target than reset left to left+right/2-2 and right to left+right/2-1
	 if the left or right value equal to target than return the value of left or right
	 return minus one 
	 */
	 @Test
	    public void tc1(){
